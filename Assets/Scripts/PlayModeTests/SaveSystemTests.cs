...
{
    /// <summary>
    /// PlayMode tests for SaveManager (MonoBehaviour lifecycle) and LocalSaveService (file I/O).
    ///
    ...
    public class SaveSystemTests
    {
        ...
        [UnityTest]
        public IEnumerator IsNewGame_TrueWhenNoSaveFileExists()
        {
        ...
        [UnityTest]
        public IEnumerator IsNewGame_FalseWhenSaveFileExists()
        {
        ...
        [UnityTest]
        public IEnumerator SaveLocal_PersistsPrestigeCount()
        {
            _saveManagerGO = new GameObject("SaveManager");
            _saveManagerGO.AddComponent<SaveManager>();
            yield return null;
        ...
        [UnityTest]
        public IEnumerator SaveLocal_PersistsPrestigeCurrency()
        {
            _saveManagerGO = new GameObject("SaveManager");
            _saveManagerGO.AddComponent<SaveManager>();
            yield return null;
        ...
        [UnityTest]
        public IEnumerator SaveLocal_PersistsTutorialState()
        {
            _saveManagerGO = new GameObject("SaveManager");
            _saveManagerGO.AddComponent<SaveManager>();
            yield return null;
