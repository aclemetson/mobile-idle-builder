...
{
    /// <summary>
    /// Drives the premium shop panel inside the game HUD.
    /// Port of MainMenuShopController adapted for the in-game slide-panel pattern.
    ...
    public class HUDPremiumShopSubController : MonoBehaviour
    {
        ...
        private void BuildSpeedUpCards()
        {
            ...
            {
                _contextLabel.text = "2x offline production speed";
            }
