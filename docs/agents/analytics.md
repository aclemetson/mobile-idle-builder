...
| `player_snapshot` | networth, base_currency, entropy_per_sec, prestige_currency, prestige_count, building_count, highest_tier, megastructure_stage, research_unlocked_count, playtime_total_sec | snapshot loop (5 min) + each prestige |
